...
class Edit_Client(tk.Toplevel):
    def __init__(self, parent):
        ...
        entry1 = tk.Entry(self, textvariable=edit_name, justify =RIGHT, font = font20)
        entry1.place(relx=.65, rely=.35,anchor= CENTER, width=int(width*0.4))
        add_bidi_support(entry1)
        ...
        code = StringVar()
        entry1 = tk.Entry(self, textvariable=code, justify = LEFT, font = font20)
        ...
        record = tk.StringVar()
        entry1 = tk.Entry(self, textvariable=record, justify = LEFT, font = font20)
        ...
        phone = tk.StringVar()
        entry1 = tk.Entry(self, textvariable=phone, justify = LEFT, font = font20)
        ...
        entry1 = tk.Entry(self, textvariable=address, justify =RIGHT, font = font20)
      ...
      def __init__(self, parent):
        ...
        def viewExpenses():
                ...
                for i in range (1, ws0.max_row+1):
                        ...
                        treev.tag_configure('even', background='#e1dddd', font=font18) 
                        treev.tag_configure('odd', background='#f5f3f3', font=font18) 
...
class Expenses_Form(tk.Toplevel):
      def __init__(self, parent):
        ...
        amount = IntVar()
        entry1 = tk.Entry(self, textvariable = amount, justify = LEFT, font = font20)
        ...
        comment = StringVar()
        entry1 = tk.Entry(self, textvariable=comment, justify = RIGHT, font = font20)
      ...
      def __init__(self, parent):
        ...
        def totalRevenues():      
                ...
                # income = total_revenue - total_expenses 
                        ...
                        Label(self, text=str(total_revenue - total_expenses),
                        bg = '#E85662', fg = 'white', font = 'fantasy 30 bold',
...
class Payment_Form(tk.Toplevel):
      def __init__(self, parent):
        ...
        amount = IntVar()
        entry1 = tk.Entry(self, textvariable = amount, justify = LEFT, font = font20)
        entry1.place(relx=.55, rely=.25,anchor= CENTER, width=int(width*0.4))
        ...
        # comment = tk.Text(self, font = font20, height=3)
        # comment.place(relx=.55, rely=.42,anchor= CENTER, width=int(width*0.4))

        comment = tk.StringVar()
        entry1 = tk.Entry(self, textvariable=comment, justify =RIGHT, font = font20)
        entry1.place(relx=.4, rely=.4,anchor= CENTER, width=int(width*0.7))
        add_bidi_support(entry1)
...
class Search(tk.Toplevel):
    def __init__(self, parent):
        ...
        def search():
                ...
                verscrlbar.pack(side ='left', fill ='x')   
                treev.configure(xscrollcommand = verscrlbar.set)
                horbar = ttk.Scrollbar(self,
                                orient ="horizontal",
                                command = treev.yview)
                horbar.pack(side ='bottom', fill ='x')   
                treev.configure(xscrollcommand = horbar.set)
                ...
                treev.column("1", width = int(1500),anchor ='e')
        ...
        def clients():
                ...
                treev["columns"] = ("1", "2", "3", "4", "5", "6")
                treev['show'] = 'headings'
                treev.column("1", width = int(width*0.7),anchor ='e')
                treev.column("2", width = int(width*0.2),anchor ='e')
                treev.column("3", width = int(width*0.1),anchor ='e')
                treev.column("4", width = int(width*0.1),anchor ='e')
...
class Client_Form(tk.Toplevel):
    def __init__(self, parent):
        ...
        name = tk.StringVar()
        entry1 = tk.Entry(self, textvariable=name, justify = RIGHT, font = font20)
        ...
        cost = IntVar()
        entry1 = tk.Entry(self, textvariable=cost, justify = LEFT, font = font20)
        ...
        comment = tk.StringVar()
        entry1 = tk.Entry(self, textvariable=comment, justify =RIGHT, font = font20)
        entry1.place(relx=.78, rely=.57,anchor= CENTER, width=int(width*0.4))
        add_bidi_support(entry1)
...
class Service_Form(tk.Toplevel):
    def __init__(self, parent):
        ...
        cost = IntVar()
        entry1 = tk.Entry(self, textvariable=cost, justify = LEFT, font = font20)
        entry1.place(relx=.55, rely=.34,anchor= CENTER, width=int(width*0.417))
        ...
        amount = IntVar()
        entry1 = tk.Entry(self, textvariable=amount, justify = LEFT, font = font20)
        entry1.place(relx=.55, rely=.58,anchor= CENTER, width=int(width*0.417))
        ...
        comment = tk.StringVar()
        entry1 = tk.Entry(self, textvariable=comment, justify =RIGHT, font = font20)
        entry1.place(relx=.4, rely=.7,anchor= CENTER, width=int(width*0.7))
        add_bidi_support(entry1)
